...
# This variable is empty because it will be overidden by the value that
# will be passed when this module is called
variable "vpc_id_var_in_compute_module" {
  type        = string
  default     = ""
  description = "vpc-id from our vpc"
}

# This variable is empty because it will be overidden by the value that
# will be passed when this module is called. e.g below
/*
...
*/
variable "pubsub_id_var_in_compute_module" {
  type        = string
  default     = ""
